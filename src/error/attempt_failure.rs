...
/// and panic failures do not contain `E` because they are generated by the retry
/// runtime, not returned by the operation.
...
impl<E> AttemptFailure<E> {
    ...
    pub fn as_error(&self) -> Option<&E> {
        match self {
            ...
            Self::Timeout | Self::Panic(_) => None,
        }
    }
    ...
    pub fn as_panic(&self) -> Option<&AttemptPanic> {
        match self {
            ...
            Self::Error(_) | Self::Timeout => None,
        }
    }
}
