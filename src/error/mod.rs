...
pub use attempt_failure_metadata::AttemptFailureMetadata;
...
pub use crate::outcome::RetryError;
pub use crate::outcome::RetryErrorMetadata;
pub use crate::outcome::RetryErrorReason;
pub use crate::outcome::RetryResult;
