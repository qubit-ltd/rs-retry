...
impl<E> Retry<E> {
    ...
    /// Returns the random source used for retry-delay selection.
    ///
    /// # Returns
    /// Random source shared by all executions of this policy.
    #[inline(always)]
    pub(in crate::executor) fn random_source(&self) -> &dyn RetryRandomSource {
